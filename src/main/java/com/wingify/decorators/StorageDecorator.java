...
public class StorageDecorator {
     ...
     * @return The feature
     */
    public Map<String, Object> getFeatureFromStorage(String featureKey, WingifyUserContext context, StorageService storageService, ServiceContainer serviceContainer) {
        try {

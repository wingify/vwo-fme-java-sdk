...
import static com.wingify.utils.ImpressionUtil.encodeURIComponent;
...
public class SetAttributeAPI {
     ...
     */
    public static void setAttribute(Map<String, Object> attributeMap, WingifyUserContext context, ServiceContainer serviceContainer) {
    ...
    private static void createAndSendImpressionForSetAttribute(
        ...
        Map<String, String> properties = NetworkUtil.getEventsBaseProperties(
                ...
                EventEnum.WINGIFY_SYNC_VISITOR_PROP.getValue(),

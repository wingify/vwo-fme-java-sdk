...
import com.wingify.utils.HoldoutUtil;

import java.util.*;
import java.util.stream.Collectors;

import static com.wingify.utils.CampaignUtil.getVariationFromCampaignKey;
...
public class GetFlagAPI {
    ...
    public static GetFlag getFlag(String featureKey, WingifyUserContext context, ServiceContainer serviceContainer) {
        ...
        if (feature.getIsDebuggerEnabled()) {
            ...
            DebuggerServiceUtil.sendDebugEventToWingify(serviceContainer.getSettingsManager(), serviceContainer.getDebuggerService().getDebugEventProps(DebuggerCategoryEnum.DECISION.getValue()));
        }

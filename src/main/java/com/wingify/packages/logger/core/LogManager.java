...
public class LogManager extends Logger implements ILogManager {
  ...
  public LogManager(Map<String, Object> config) {
    ...
    Object configuredPrefix = config.get("prefix");
    this.prefix = (configuredPrefix != null && !configuredPrefix.toString().isEmpty())
        ? configuredPrefix.toString()
        : Boolean.TRUE.equals(config.get("isViaVWO")) ? "VWO-SDK" : "WINGIFY-SDK";

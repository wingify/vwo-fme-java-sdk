...
public class LogMessageBuilder {
    ...
    public LogMessageBuilder(Map<String, Object> loggerConfig, Map<String, Object> transport) {
        ...
        String transportPrefix = (String) this.transport.get("prefix");
        Object configuredPrefix = loggerConfig.get("prefix");
        this.prefix = (transportPrefix != null && !transportPrefix.isEmpty())
                ? transportPrefix
                : (configuredPrefix != null && !configuredPrefix.toString().isEmpty())
                        ? configuredPrefix.toString()
                        : Boolean.TRUE.equals(loggerConfig.get("isViaVWO")) ? "VWO-SDK" : "WINGIFY-SDK";

...
public class BatchEventQueue {
    ...
    public void enqueue(EventArchPayload eventData) {
        synchronized (LockObject) {
            Map<String, Object> payload = WingifyClient.objectMapper.convertValue(eventData, Map.class);
    ...
    private boolean sendBatchEvents(List<Map<String, Object>> events) {
        try {
            ...
            loggerService.log(LogLevelEnum.ERROR, "Error sending batch to Wingify server: " + ex.getMessage());

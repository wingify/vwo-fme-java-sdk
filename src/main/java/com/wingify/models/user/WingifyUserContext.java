...
import static com.wingify.utils.FunctionUtil.generateSessionId;

public class WingifyUserContext {
    private String id;
    ...
    private GatewayService _wingify;
    ...
    public GatewayService getWingify() {
        return _wingify;
    }

    public void setWingify(GatewayService wingify) {

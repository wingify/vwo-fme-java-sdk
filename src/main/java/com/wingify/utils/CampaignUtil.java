...
public class CampaignUtil {
     ...
     * @param context A WingifyUserContext object containing user information.
     * @return The identifier to be used for bucketing (either the CustomBucketingSeed or the UserID).
     */
    public static String getBucketingId(WingifyUserContext context) {
     ...
     */
    public static String getUserIdForLogging(WingifyUserContext context) {
        String userId = context.getId();

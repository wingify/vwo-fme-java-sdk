...
import com.wingify.models.user.Alias;
import com.wingify.models.user.AliasSetResponse;
...
public class AliasingUtil {
    ...
    public static String getAlias(String userId, ServiceContainer serviceContainer) throws Exception {
        ...
        String userIdJSON = WingifyClient.objectMapper.writeValueAsString(Collections.singletonList(userId));
        ...
        List<Alias> aliasList = WingifyClient.objectMapper.readValue(response, new TypeReference<List<Alias>>() {});
    ...
    public static Boolean setAlias(String userId, String aliasId, ServiceContainer serviceContainer) throws Exception {
        ...
        AliasSetResponse aliasSetResponse = WingifyClient.objectMapper.readValue(response, AliasSetResponse.class);
